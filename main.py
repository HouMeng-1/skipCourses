...
user = driver.find_element(By.XPATH,'/html/body/div[4]/div/form/div[1]/ul[1]/li[1]/input[4]')
password = driver.find_element(By.XPATH, '/html/body/div[4]/div/form/div[1]/ul[1]/li[2]/input')
...
def getTime():
    currentTime = driver.find_element(By.XPATH, '/html/body/div[1]/div[1]/div[2]/div[1]/div/div/div/div[10]/div[4]/span[1]').text
    duration = driver.find_element(By.XPATH, '/html/body/div[1]/div[1]/div[2]/div[1]/div/div/div/div[10]/div[4]/span[2]').text
...
for i in range(3704 - 3673 + 1):
    ...
    print(f'视频{i}: {name}, 开始时间:{datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")}')
